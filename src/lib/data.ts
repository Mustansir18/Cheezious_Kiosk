...
export const menuItems: MenuItem[] = [
  ...
  { id: 'bz-03', name: 'Bazinga Combo', description: 'A Bazinga burger with fries and a drink.', price: 300, category: 'Bazinga!', imageId: 'bazinga-combo' },
